    ...
    <div class="mt-[50px] grid lg:grid-cols-3 sm:grid-cols-2 gap-8">
      <div class="rounded-[30px] p-8 h-[320px] flex justify-center bg-white group">
        <div class="overflow-hidden flex flex-col items-center justify-center text-center group-hover:text-left group-hover:items-start group-hover:justify-center">
          <img class="transition ease-in-out delay-1500 w-20 group-hover:w-8" src="{{ asset('images/about/icons/image 62.png') }}" alt="Kaddah Janitor">
      ...
      <div class="rounded-[30px] p-8 h-[320px] flex justify-center bg-white group">
        <div class="overflow-hidden flex flex-col items-center justify-center text-center group-hover:text-left group-hover:items-start group-hover:justify-center">
          <img class="transition ease-in-out delay-1500 w-20 group-hover:w-8" src="{{ asset('images/about/icons/image 64.png') }}" alt="Kaddah Patient">
      ...
      <div class="rounded-[30px] p-8 h-[320px] flex justify-center bg-white group">
        <div class="overflow-hidden flex flex-col items-center justify-center text-center group-hover:text-left group-hover:items-start group-hover:justify-center">
          <img class="transition ease-in-out delay-1500 w-20 group-hover:w-8" src="{{ asset('images/about/icons/image 59.png') }}" alt="Kaddah Industry">
      ...
      <div class="rounded-[30px] p-8 h-[320px] flex justify-center bg-white group">
        <div class="overflow-hidden flex flex-col items-center justify-center text-center group-hover:text-left group-hover:items-start group-hover:justify-center">
          <img class="transition ease-in-out delay-1500 w-20 group-hover:w-8" src="{{ asset('images/about/icons/image 60.png') }}" alt="Kaddah Education">
      ...
      <div class="rounded-[30px] p-8 h-[320px] flex justify-center bg-white group">
        <div class="overflow-hidden flex flex-col items-center justify-center text-center group-hover:text-left group-hover:items-start group-hover:justify-center">
          <img class="transition ease-in-out delay-1500 w-20 group-hover:w-8" src="{{ asset('images/about/icons/image 63.png') }}" alt="Kaddah Hospitality">
      ...
      <div class="rounded-[30px] p-8 h-[320px] flex justify-center bg-white group">
        <div class="overflow-hidden flex flex-col items-center justify-center text-center group-hover:text-left group-hover:items-start group-hover:justify-center">
          <img class="transition ease-in-out delay-1500 w-20 group-hover:w-8" src="{{ asset('images/about/icons/image 61.png') }}" alt="Kaddah Food Service">

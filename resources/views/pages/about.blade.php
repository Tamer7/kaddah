@extends('master')
@section('pkeywords', 'cleaning product supplier,cleaning equipement supplier')
@section('title', 'Cleaning Product Supplier')
@description('description', 'With over 30 years' experience, Kaddah Cleaning Equipment has evolved from a small warehouse to an industry leader, specialising in innovative cleaning solutions.')
@section('content')
    ...
    <div class="page-header">
        <div class="container">
            ...
            <h5 style="color: transparent; position: absolute;">
             We are a leading cleaning product and equipment supplier in Dubai. While our expertise lie in cleaning materials, we also pride ourselves in our impeccable customer service.
             Our comprehensive range, coupled with our commitment to customer satisfaction, makes us the first choice for many businesses and individuals across the region.
            </h5>
        </div>
    </div>
    <!-- End of Page Header -->
    ...
    <div class="page-content">
        <div class="container">
            <section class="introduce mb-10 pb-10">
                ...
                <figure class="br-lg">
                    <img src="{{asset('images/pages/about_us/1.jpg')}}" alt="Banner" 
            ...
            <section class="customer-service mb-7">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 mb-8">
                        <figure class="br-lg">
                            <img src="{{asset('images/pages/about_us/2.jpg')}}" alt="Banner"
        ...
        <section class="boost-section pt-10 pb-10">
            <div class="container mt-10 mb-9">
                <div class="row align-items-center mb-10">
                    <div class="col-md-6 mb-8">
                        <figure class="br-lg">
                            <img src="{{asset('images/pages/about_us/3.jpg')}}" alt="Banner"
                        ...
                        <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-md-2 cols-1">
                            <div class="swiper-slide image-box-wrapper">
                                <div class="image-box text-center">
                                    <figure>
                                        <img src="{{asset('images/pages/about_us/1.png')}}" alt="Award Image" width="109" height="105" />
                                    </figure>
                            ...
                            <div class="swiper-slide image-box-wrapper">
                                <div class="image-box text-center">
                                    <figure>
                                        <img src="{{asset('images/pages/about_us/2.png')}}" alt="Award Image" width="109" height="105" />
                                    </figure>
                            ...
                            <div class="swiper-slide image-box-wrapper mt-3">
                                <div class="image-box text-center">
                                    <figure>
                                        <img src="{{asset('images/pages/about_us/3.png')}}" alt="Award Image" width="109" height="105" />
                                    </figure>
                            ...
                            <div class="swiper-slide image-box-wrapper">
                                <div class="image-box text-center">
                                    <figure>
                                        <img src="{{asset('images/pages/about_us/4.png')}}" alt="Award Image" width="109" height="105" />
                                    </figure>
                ...
                <div class="swiper-container swiper-theme" data-swiper-options="{
                    ...
                    <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-sm-2 cols-1">
                        <div class="swiper-slide member-wrap">
                            <figure class="br-lg">
                                <img src="{{asset('images/pages/about_us/4.jpg')}}" alt="Member" width="295" height="332" />
                                <div class="overlay">
                        ...
                        <div class="swiper-slide member-wrap">
                            <figure class="br-lg">
                                <img src="{{asset('images/pages/about_us/5.jpg')}}" alt="Member" width="295" height="332" />
                                <div class="overlay">
                                    <div class="social-icons">
                                        <a href="#" class="social-icon social-facebook w-icon-facebook"></a>
                                        <a href="#" class="social-icon social-twitter w-icon-twitter"></a>
                        ...
                        <div class="swiper-slide member-wrap">
                            <figure class="br-lg">
                                <img src="{{asset('images/pages/about_us/6.jpg')}}" alt="Member" width="295" height="332" />
                                <div class="overlay">
                                    <div class="social-icons">
                                        <a href="#" class="social-icon social-facebook w-icon-facebook"></a>
                                        <a href="#" class="social-icon social-twitter w-icon-twitter"></a>
                        ...
                        <div class="swiper-slide member-wrap">
                            <figure class="br-lg">
                                <img src="{{asset('images/pages/about_us/7.jpg')}}" alt="Member" width="295" height="332" />
                                <div class="overlay">
                                    <div class="social-icons">
                                        <a href="#" class="social-icon social-facebook w-icon-facebook"></a>
                                        <a href="#" class="social-icon social-twitter w-icon-twitter"></a>

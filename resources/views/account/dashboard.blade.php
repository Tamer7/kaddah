        ...
        <div class="container">
            <div class="tab tab-vertical row gutter-lg">
                <ul class="nav nav-tabs mb-6" role="tablist">
                    ...
                    <li class="nav-item">
                        <a href="#account-orders" class="nav-link" onClick="getOrders()">Orders</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="link-item" style="display:none;">
                        <a href="/wishlist">Wishlist</a>
                    </li>
                    <li class="link-item">
                        <a href="javascript:void(0)" onClick="$('#logout-user').submit()">Logout</a>
                    </li>
                </ul>
                ...
                <div class="tab-content mb-6">
                    <div class="tab-pane active in" id="account-dashboard">
                        <p class="greeting">
                            ...
                            (not
                            <span class="text-dark font-weight-bold">{{$user->name}}</span>?
                            <a href="javascript:void(0)" onClick="$('#logout-user').submit()" class="text-primary">Log out</a>)
                        </p>

                        <p class="mb-4">
                            From your account dashboard you can view your <a href="#account-orders"
                                class="text-primary link-to-tab">recent quotations</a>,
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mb-4">
                                <a href="#account-orders" class="link-to-tab" onClick="getOrders()">
                                    <div class="icon-box text-center">
                                        <span class="icon-box-icon icon-orders">
                                            <i class="w-icon-orders"></i>
                                        </span>
                                        <div class="icon-box-content">
                                            <p class="text-uppercase mb-0">Quotations</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
...
{{--                                </a>--}}
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mb-4">
                                <a href="javascript:void(0)" onClick="$('#logout-user').submit()">
                                    <div class="icon-box text-center">
                    ...
                    <div class="tab-pane mb-4" id="account-orders">
                        ...
                        <table class="shop-table account-orders-table mb-6">
                            ...
                            <tbody id="orders_body">
                                <tr>
                                    <td><div class="items-loader"><div></div><div></div><div></div><div></div></div></td>
                                </tr>
                            </tbody>
                        </table>
...
<script>
                ...
                $.each(res, function(index, order) {
                    orders += `
                        <tr>
                            ...
                            <td class="order-date">${dateFormat(order.created_at)}</td>
                            ...
                            <td class="order-action">
                                <a href="javascript:void(0)" onClick="order(event, '${order.tracking_id}')"
                                    class="click-loader btn btn-outline btn-default btn-block btn-sm btn-rounded">View</a>
                            </td>
                        </tr>
                    `;
                });
    ...
    function order(event, tracking) {
        var button = $(event.target);
        var loader = '<span class="atlantic-spinner atlantic-spinner-black"></span>';

        button.html(loader);
        window.location.href = '{{route("user.order", ":tracking")}}'.replace(':tracking', tracking);
    }

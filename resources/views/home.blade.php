<x-layout noDecorator>
    ...
    <div class="flex flex-col lg:flex-row items-center py-8 lg:py-[106px] px-8 lg:px-24 relative lg:h-[600px]">
        <div class="flex flex-col justify-center lg:w-1/2 text-center lg:text-left">
            ...
            <h1 class="font-semibold text-[32px] lg:text-[52px] text-[theme(colors.blue)] py-2">
                The region's biggest selection of cleaning solutions
            </h1>
            <p class="w-full lg:w-8/12 xl:w-full">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
            <div class="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 mt-6">
                <a href="/products" class="bg-[theme(colors.blue)] rounded-[28px] px-8 py-4 text-sm font-semibold text-white hover:opacity-80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
                    Our Products
                </a>
                <a href="/about-us" class="bg-gray-800 rounded-[28px] px-12 py-4 text-sm font-semibold text-white hover:opacity-80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
                    About Us
                </a>
            </div>
        </div>

        <div class="flex lg:w-1/2 justify-center lg:justify-end mt-8 lg:mt-0">
            <img src="/images/home/Mask group.png" alt="" class="max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl h-auto mx-auto lg:static lg:transform-none">
        </div>
    </div>
    ...
    {{-- <div class="relative flex flex-col lg:flex-row py-8 lg:py-[106px] px-8 lg:px-24 lg:h-[600px]">
        <div class="flex flex-col justify-center lg:w-1/2">
            <div class="pt-4 lg:pt-0"><i class="fa-regular fa-circle-check"></i> Representing Since 1989</div>
            <h1 class="font-semibold text-[32px] lg:text-[52px] text-[theme(colors.blue)] py-2">
                The region's biggest selection of cleaning solutions
            </h1>
            <p class="lg:w-8/12 xl:w-full">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
            <div class="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 mt-6">
                <a href="/products" class="bg-[theme(colors.blue)] rounded-[28px] px-8 py-4 text-sm font-semibold text-white hover:opacity-80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
                    Our Products
                </a>
        ...
        <div class="lg:w-1/2 flex justify-end lg:relative">
            <img src="/images/home/Mask group.png" alt="" class="lg:absolute max-w-xs sm:max-w-sm md:max-w-md lg:max-w-full h-auto -top-[96px] lg:right-0">
        </div>
    </div> --}}


    <div class="pt-8 bg-[#E5F8FF]">
        <div class="lg:pl-32 lg:py-24 p-8 flex flex-col lg:flex-row">
            <img src="/images/home/Group 59.png" alt="" class="py-4 mx-auto lg:mx-0">
            <div class="lg:pl-20 pl-12 pt-4 lg:pt-0">
                <h2 class="font-bold text-[32px] lg:text-[46px] mx-auto lg:mx-0 lg:max-w-[500px] text-center lg:text-left">Your Trusted Cleaning Supplies & Equipment Provider.</h2>
                <ul class="list-image-[url(/images/checkmark.png)] mt-8 mx-auto lg:mx-0 lg:max-w-[500px]">
    ...
    <x-subpanel title="The Cleaning Pioneers" more="View All Categories">
        <x-slot name="header">
        <div class="font-semibold mb-4 text-2xl text-[theme(colors.blue)]">Main Categories</div>
        </x-slot>

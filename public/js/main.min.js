...
$.extend($.easing, {
    ...
    function(t) {
        ...
        Wolmart.$window = t(window),
            Wolmart.$body = t(document
                .body), Wolmart.status =
            "", Wolmart.isIE = navigator
            .userAgent.indexOf(
                "Trident") >= 0, Wolmart
            .isEdge = navigator
            .userAgent.indexOf(
            ...
            }, Wolmart.byId = function(
                t) {
                return document
                    .getElementById(t)
            }, Wolmart.byTag = function(
                t, e) {
                return e ? e
                ...
                return e.prototype
                    .init = function(e,
                        ...
                        this.$el = e,
                            ...
                            .on("sticky_refresh_size.Wolmart",
                                this
                                .refreshSize
                                .bind(
                                    this
            ...
            }, Wolmart.initNavFilter =
            function(e) {
                t.fn.isotope && Wolmart
                    .$(e).on("click", (
                        function(
                        e) {
                            var i =
            ...
            function(e) {
                if (t.fn.themeSticky) {
                    ...
                    }!t(".sticky-sidebar > .filter-actions")
                        .length && t(
                            window)
                        .width() >=
                        992 && t(
        ...
        var e = function(t) {
            ...
            a = {
                ...
                initMobileMenu: function() {
                    t(".mobile-menu li, .toggle-menu li")
                        .each((function() {
                            if (this
                                .lastElementChild &&
                                ("UL" ===
    ...
    function(t) {
        ...
        e.defaults = {
            ...
            function() {
                t(".swiper-container:not([class*='pg-']) .swiper-pagination")
                    .each((function() {
                        var e =
                            t(
                                this);
    ...
    function(t) {
        var e = {
                ...
                Wolmart.call(
                    ...
                    .$body.on(
                        ...
                        (function(
                            ...
                            t(".shop-sidebar .filter-items .active")
                                .removeClass(
                                    "active"
                                    ),
                                e
                    ...
                    Wolmart.$body.on(
                        "click", ".product:not(.product-select) .btn-cart, .product-popup .btn-cart, .home .product-single .btn-cart",
                        (function(e) {
                            e.preventDefault();
                            var i = t(this),
                                    ...
                                    setTimeout((function() {
                                        i.removeClass("load-more-overlay loading"),
                                            Wolmart.Minipopup.open({
                                                ...
                                                message: "<p>"+i.text()+"</p>",
                                                actionTemplate: '<a href="/cart" class="btn btn-rounded btn-sm">View Cart</a><a href="/cart/checkout" class="btn btn-dark btn-rounded btn-sm">REQUEST A QUOTE</a>'
                                            })
                                        }),
                                        500
                                        )
                    ...
                    .length &&
                    Wolmart
                    .$body.on("click", ".btn-quickview", (function(i) {
                            i.preventDefault(),
                                Wolmart.popup({
                                        items: {
                                            src: e[0].outerHTML
            ...
            initVariation: function(
                e) {
                t(".product:not(.product-single) .product-variations > a")
                    .on("click",
                        (function(
                            e
                            ) {
            ...
            initProductsScrollLoad: function(e) {
                ...
                var o =
                    function(e) {
                        window.pageYOffset > i + a
                            .outerHeight() -
                            window.innerHeight - 150 && "loading" != a
                            .data("load-state") && t.ajax({
                                url: n,
                                success: function(e) {
                                    var i = t(e);
                                    a.data("load-state",
                ...
                o.$wrapper = e, o
                    ...
                    .find(
                        ...
                        .on("click",
                            ...
                            o
                            .clickStickyThumbnail
                            .bind(this)
                            ), window
                        .addEventListener(
                            "scroll", o
                            .scrollStickyThumbnail
                            .bind(
                            this), {
                                passive:
                                    !0
        ...
        function() {
            ...
            function(e) {
                ...
                var o = a.closest(
                    ...
                    ".product-image-wrapper > :nth-child(" +
                    n + ")");
                o.length && (o = o
                        .offset().top +
                        10, Wolmart
    ...
    function(t) {
        ...
        function n(e) {
            var i = t(this),
                a = t(
                    ".main-content > .alert, .container > .alert"
                    );
    ...
    function(t) {
        ...
        e.defaultOptions = {
            ...
            function(e, i) {
                ...
                n.append(o), n.append(
                    s), i.append(n)
            }, e.prototype.changeMonth =
            function(e) {
                this.today.setMonth(this
                    .today
                    .getMonth() + e,
                    1), this.render(
                    this.today, t(
    ...
    .initLayout = function() {
        ...
        Wolmart.appearAnimate(
            ...
            Wolmart.parallax(
                ".parallax"), Wolmart
            .skrollrParallax(), Wolmart
            .initFloatingParallax(),
            Wolmart.menu.init(), Wolmart
            .initScrollTopButton(),
            Wolmart.shop.init(), Wolmart
            .alert(".alert"), Wolmart
            .closeTopNotice(
                ".banner-close"),
            Wolmart.accordion(
